    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="update_benefit">Update Employee Benefit</h5>
...
<script>
  ...
  //------------------------------------------------
        ...
        $('.update').click(function(e) {
            ...
            var vdata = {  id: id };
            $.ajax({
                url: "{{ route('employee_benefits.edit') }}",
                type: "post",
                data: vdata,
  ...
  //--------------------------------------------------
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            e.preventDefault();
            var id = $('#emp_benefit_id').val(); 
            var formData = $(this).serialize();

            $.ajax({
                type: 'post', 
                url: "{{ route('employee_benefits.update')}}",
                data: formData,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                success: function(response) {
                    $('#successMessage').append(response.success);
