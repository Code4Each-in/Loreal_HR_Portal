...
<form id="salaryForm" class="form-design" action="/grade_salary_master" method="POST">
    @csrf
            ...
            <section class="main-section">
                ...
                <section class="cal2">
                    <div class="design-button">
                        <h4>Source Factor</h4>
                        <div class="cal-button ">
                            <a oSalaryHeadnclick="showFormula('{Basic_PAY}')" class="button-deisgn">Basic pay</a>
                ...
                <section class="calculator">
                    ...
                    <div class="cal-section">
                        <a oncliSalaryHeadck="showFormula('4')">4</a>
