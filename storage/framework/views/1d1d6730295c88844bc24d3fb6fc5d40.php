            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="<?php echo e(url('login')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="col-12">
                    ...
                    <?php if($errors->has('credentials_error')): ?>
                         <span class="text-danger"><?php echo e($errors->first('credentials_error')); ?></span>
                   <?php endif; ?>
                    <div class="col-12">
...
</html><?php /**PATH D:\LOreal_HR_Portal\resources\views/login/index.blade.php ENDPATH**/ ?>